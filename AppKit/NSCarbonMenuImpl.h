...
- (void)_menuItem:(id)arg1 atIndex:(unsigned long long)arg2 didChangeRadialMenuTitleFrom:(id)arg3 to:(id)arg4;
- (void)_menuItem:(id)arg1 atIndex:(unsigned long long)arg2 didChangeRadialMenuImageFrom:(id)arg3 to:(id)arg4;
