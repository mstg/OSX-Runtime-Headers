...
@class NSArray, NSConditionLock, NSDate, NSDocument, NSError, NSFileVersion, NSMetadataQuery, NSMutableArray, NSNumber, NSOperationQueue, NSPointerArray, NSSavePanel, NSString, NSTimer, NSURL, _NSDocumentActivity, _NSDocumentFileAccess;
