...
- (id)_constraintsForTrailingView:(id)arg1 identifierIndex:(long long)arg2 spacing:(double)arg3 canLiveCollapse:(BOOL)arg4;
- (id)_constraintsForLeadingView:(id)arg1 identifierIndex:(long long)arg2 spacing:(double)arg3 canLiveCollapse:(BOOL)arg4;
