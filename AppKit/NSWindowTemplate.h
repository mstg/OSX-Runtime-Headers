...
@property struct CGSize maxFullScreenContentSize; // @synthesize maxFullScreenContentSize=_maxFullScreenContentSize;
@property struct CGSize minFullScreenContentSize; // @synthesize minFullScreenContentSize=_minFullScreenContentSize;
