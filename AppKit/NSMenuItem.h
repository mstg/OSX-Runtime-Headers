...
#import "NSRadialMenuItem.h"
#import "NSValidatedUserInterfaceItem.h"

@class NSAttributedString, NSImage, NSMenu, NSString, NSView;

@interface NSMenuItem : NSObject <NSImmediateActionAnimationController, NSPopoverPresenting, NSMenuItem, NSRadialMenuItem, NSCopying, NSCoding, NSValidatedUserInterfaceItem>
{
    NSMenu *_menu;
    NSString *_title;
...
- (id)radialMenuImage;
- (void)setRadialMenuImage:(id)arg1;
...
- (id)radialMenuTitle;
- (void)setRadialMenuTitle:(id)arg1;
...
- (void)_doTransitionAnimationAnchoredFromEdge:(unsigned long long)arg1 ofPoint:(struct CGPoint)arg2 originRect:(struct CGRect)arg3 originIcon:(id)arg4 iconRect:(struct CGRect)arg5 originControlPoints:(struct CGPoint *)arg6 appearance:(id)arg7;
@property(readonly) BOOL _wantsTransitionAnimationCallback;
