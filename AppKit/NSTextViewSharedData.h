...
@class NSArray, NSAttributedString, NSColor, NSDictionary, NSParagraphStyle, NSRulerView, NSSelectionArray, NSSharingServicePicker, NSTextContainer, NSTextFinder, NSTextInputContext, NSTextView, NSUndoManager, NSWindow;
