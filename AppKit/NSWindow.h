...
@class NSAppearance, NSArray, NSColor, NSColorSpace, NSDictionary, NSDockTile, NSEvent, NSGraphicsContext, NSImage, NSMutableSet, NSScreen, NSString, NSToolbar, NSURL, NSView, NSViewController, NSWindowAuxiliary, NSWindowController;
...
- (struct CGSize)_tileMaxSize;
- (struct CGSize)_tileMinSize;
...
- (void)_cancelExitFullScreenModeAfterDelay:(id)arg1;
- (void)_exitFullScreenModeAfterDelay:(id)arg1;
- (void)_performDelayedExitFullScreenMode:(id)arg1;
...
- (struct CGRect)_frameForFullScreenModeInRect:(struct CGRect)arg1 forTile:(BOOL)arg2;
...
- (BOOL)_isTiledInFullScreenByDock;
...
- (void)_windowReallyMoved:(id)arg1;
- (BOOL)_shouldUnsnapHeight;
- (void)setSnappedEdges:(unsigned long long)arg1;
...
- (void)_handleLookupEvent:(id)arg1;
- (void)_handleKeyDownEvent:(id)arg1;
- (void)_handleKeyUpEvent:(id)arg1;
- (void)_handleCursorUpdateEvent:(id)arg1;
- (void)_handleMouseEnteredOrExitedEvent:(id)arg1;
- (void)_handleScrollWheelEvent:(id)arg1;
- (void)_handleMouseMovedEvent:(id)arg1;
- (void)_handleOtherMouseUpEvent:(id)arg1;
- (void)_handleOtherMouseDownEvent:(id)arg1;
- (void)_handleRightMouseUpEvent:(id)arg1;
- (void)_handleRightMouseDownEvent:(id)arg1;
- (void)_handleMouseUpEvent:(id)arg1 isDelayedEvent:(BOOL)arg2;
...
- (void)_setSuppressShadowPreloading:(BOOL)arg1;
- (id)shadowParameters;
...
- (void)_setFullScreenTiled:(BOOL)arg1 spid:(unsigned long long)arg2 subspid:(unsigned long long)arg3;
...
- (BOOL)allowsSnapping;
- (void)_unsnapFrameHeightWithEvent:(id)arg1 resizeEdge:(unsigned long long)arg2;
- (void)_unsnapFrameWithEvent:(id)arg1;
- (void)_snapWidthToFrame:(struct CGRect)arg1 withEvent:(id)arg2;
- (void)_snapHeightToFrame:(struct CGRect)arg1 withEvent:(id)arg2;
- (void)_snapToFrame:(struct CGRect)arg1 withEvent:(id)arg2;
- (void)_snapOrUnsnapToFrame:(struct CGRect)arg1 widthSnapped:(BOOL)arg2 heightSnapped:(BOOL)arg3 withEvent:(id)arg4;
...
- (struct CGRect)_frame:(struct CGRect)arg1 resizedFromEdge:(unsigned long long)arg2 withDelta:(struct CGSize)arg3 withEvent:(id)arg4 withInfo:(struct NSTitledFrameResizeInfo *)arg5 velocityFilter:(struct PKG2DVelocityFilter *)arg6;
- (BOOL)_resizingShouldSnapToWindows;
- (unsigned long long)_calculateCurrentSnappedEdgesFromFrame:(struct CGRect)arg1 snappingRects:(struct CGRect *)arg2 count:(long long)arg3;
...
- (void)setWidthSnapped:(BOOL)arg1;
- (BOOL)isWidthSnapped;
- (void)setHeightSnapped:(BOOL)arg1;
- (BOOL)isHeightSnapped;
- (BOOL)isFrameSnapped;
