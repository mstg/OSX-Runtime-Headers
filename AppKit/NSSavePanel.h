...
- (void)_layoutViewsVerticallyAndResizeWindowToLastExpandedSize:(BOOL)arg1 accessoryViewHeight:(double)arg2 parentWindow:(id)arg3 navViewMinSize:(struct CGSize)arg4;
...
- (struct CGSize)_getAndAdjustContentMinSizeWithNavViewMinSize:(struct CGSize)arg1 isExpanded:(BOOL)arg2;
- (struct CGRect)_visibleFrameAvailableForPanelWithParentWindow:(id)arg1;
- (void)_fixFetchExpandedFrameSizeForVisibleFrameWithParentWindow:(id)arg1 navViewMinSize:(struct CGSize)arg2;
...
- (struct CGSize)_minNonExpandedFrameSize:(struct CGSize)arg1;
- (struct CGSize)_minExpandedFrameSize:(struct CGSize)arg1;
- (double)_computeMinPixelHeightForSimpleSavePanel:(BOOL)arg1 navViewMinHeight:(double)arg2;
