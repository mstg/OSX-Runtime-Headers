...
@class CALayer, CIFilter, NSAppearance, NSArray, NSDictionary, NSMenuItem, NSPressureConfiguration, NSScrollView, NSShadow, NSString, NSTextInputContext, NSURL, NSViewController, NSWindow, _NSViewAuxiliary;
...
- (void)_setActionMenu:(id)arg1;
- (id)_actionMenu;
- (void)setRadialMenu:(id)arg1;
- (id)radialMenu;
...
- (BOOL)_shouldDisableBaseVibrancy;
