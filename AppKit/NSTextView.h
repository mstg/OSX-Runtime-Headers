...
+ (id)defaultActionMenu;
+ (id)defaultRadialMenu;
...
- (void)prepareMenu:(id)arg1 forCharacterAtIndex:(unsigned long long)arg2 withEvent:(id)arg3;
...
- (BOOL)_usesLookupForActionMenuSelectionAdjustment;
