...
@interface NSPopoverColorWell : NSColorWell <NSMenuDelegate, NSPopoverDelegate>
{
...
- (BOOL)isOpaque;
- (struct CGPoint)_locationForMenu:(id)arg1 preparingAtLocation:(struct CGPoint)arg2 inView:(id)arg3;
- (void)_setColorFromMenuItem:(id)arg1;
