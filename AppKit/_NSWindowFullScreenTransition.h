...
- (void)exitFullScreenTransitionForWindow:(id)arg1 options:(CDStruct_8e9e3288)arg2;
- (void)_performExitFullScreenModeForWindow:(id)arg1 options:(CDStruct_8e9e3288)arg2 customWindows:(id)arg3 doKitAnimation:(BOOL)arg4;
