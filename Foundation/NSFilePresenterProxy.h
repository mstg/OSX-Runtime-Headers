...
@class NSFileAccessProcessManager, NSFileWatcher, NSMutableArray;
...
- (void)startObservingApplicationStateWithQueue:(struct dispatch_queue_s *)arg1 suspensionHandler:(CDUnknownBlockType)arg2;
